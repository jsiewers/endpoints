...
public class ConferenceApi {
    ...
    public Profile saveProfile(final User user, ProfileForm profileForm) throws UnauthorizedException { 	
        ...
        // TODO 1
        // Set the teeShirtSize to the value sent by the ProfileForm
        ...
        Profile profile = (Profile) ofy().load().key(Key.create(Profile.class, userId)).now(); // TODO load the Profile entity
...
/**
    ...
    public List<Conference> getConferencesCreated(User user) throws UnauthorizedException {
    	...
    	Key userKey = Key.create(user.getUserId());
